...
@Component({
  ...
  template: `
    @if (isOpen()) {
      ...
      >
        <div
          class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800 animate-slide-up p-6"
        >
          <app-modal-header
          ...
          <form (ngSubmit)="onSubmit()" class="mt-4 space-y-4">
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-600 outline-none transition-all pr-10 shadow-xs"
                  (blur)="onUrlBlur()"
                />
                @if (bookmarkService.scraping()) {
                  <div class="absolute right-3.5 top-3 text-brand-600 dark:text-brand-400 animate-spin">
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-600 outline-none transition-all shadow-xs"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-600 outline-none transition-all resize-none shadow-xs"
              ></textarea>
            </div>
            ...
            <div>
              ...
              <select
                [(ngModel)]="folderId"
                name="folderId"
                class="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-600 outline-none transition-all shadow-xs"
              >
            ...
            <div class="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  name="ogImage"
                  placeholder="https://..."
                  class="w-full px-3 py-2 text-xs rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-brand-500/30 focus:border-brand-600 outline-none transition-all shadow-xs"
                />
              </div>
              <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 mb-1.5">
